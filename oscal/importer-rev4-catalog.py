...
# load the catalog
oscal = open('nist.gov/SP800-53/rev4/json/NIST_SP-800-53_rev4_catalog.json', 'r', encoding='utf-8-sig')
...
with open("rev4artifacts/resources.json", "w") as outfile: 
...
# # Write to file to visualize the output
with open("rev4artifacts/families.json", "w") as outfile: 
    outfile.write(json.dumps(families, indent=4)) 

# # Write to file to visualize the output
with open("rev4artifacts/controls.json", "w") as outfile: 
...
# Write to file to visualize the output
with open("rev4artifacts/mappedControls.json", "w") as outfile: 
