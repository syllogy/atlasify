...
parser = argparse.ArgumentParser(description='Atlasity parser for the CIS Version 8 IG-2')
...
# setup catalog data
cat = {
    "title": "CIS Controls Version 8 - Implementation Group 2",
    ...
    + "<br /> IG2 assists enterprises managing IT infrastructure of multiple departments with differing risk profiles. IG2 aims to help enterprises cope with increased operational complexity",
...
# load local json
f = open('ig-2.json', 'r', encoding='utf-8-sig')
data = json.load(f)
...
for i in data["CIS Controls Version 8 Implementation Group 2"]:
    mappings = ""
